...
output_dir = "/home/exaFLOPs/Documents/IsaacLab/source/isaaclab_assets/data/Kitchen"
...
# Loop to generate 100 USD files
for i in range(1, 101):
    # Set the filename for the current iteration
    usd_filename = os.path.join(output_dir, f"Kitchen_{i:02d}.usd")
    
    # Set a unique seed for each kitchen to ensure diversity
    random.seed(i)

    # Generate a random kitchen
    kitchen = ps.kitchen(seed=i)
    ...
    print(f"Generated USD file: {usd_filename}")
