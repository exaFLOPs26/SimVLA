...
#				self.sim.render()	
		...
		if len(reset_env_ids) > 0:
			...
			episodedata = self.recorder_manager.record_pre_reset(reset_env_ids)
...
#				self.sim.render()
		...
		return self.obs_buf, self.reward_buf, self.reset_terminated, self.reset_time_outs, self.extras, episodedata
