...
class KitchenSceneCfg(InteractiveSceneCfg): 
	...
	kitchen = AssetBaseCfg(
		...
		spawn=sim_utils.UsdFileCfg(usd_path="file:/root/IsaacLab/scripts/isaacsim/kitchen_bodex.usd"),
	)
...
# -------Change-------
	...
	bowl = RigidObjectCfg(
						...
						init_state=RigidObjectCfg.InitialStateCfg(
							pos=(1.513, -0.7937, 0.7818),
							rot=(0.6655, 0.0, 0.0, 0.7464),
						),
					)
	corner = RigidObjectCfg(
						...
						spawn=None,
						init_state=RigidObjectCfg.InitialStateCfg(
							pos=(1.8149, -0.035, 0.3725),
							rot=(1.0, 0.0, 0.0, 0.0),
						),
					)
	corner_0 = RigidObjectCfg(
						prim_path="{ENV_REGEX_NS}/Kitchen/corner_0",
						spawn=None,
						init_state=RigidObjectCfg.InitialStateCfg(
							pos=(1.8149, -2.3428, 0.3725),
							rot=(-0.7071, 0.0, 0.0, 0.7071),
						),
					)
	corner_3 = RigidObjectCfg(
						prim_path="{ENV_REGEX_NS}/Kitchen/corner_3",
						spawn=None,
						init_state=RigidObjectCfg.InitialStateCfg(
							pos=(-0.8149, -0.035, 0.3725),
							rot=(1.0, 0.0, 0.0, 0.0),
						),
					)
	countertop_base_cabinet = RigidObjectCfg(
						...
						spawn=None,
						init_state=RigidObjectCfg.InitialStateCfg(
							pos=(0.9041, 0.0, 0.7629),
							rot=(1.0, 0.0, 0.0, 0.0),
						),
					)
	countertop_base_cabinet_0 = RigidObjectCfg(
						prim_path="{ENV_REGEX_NS}/Kitchen/countertop_base_cabinet_0",
						spawn=None,
						init_state=RigidObjectCfg.InitialStateCfg(
							pos=(0.9041, -2.3778, 0.7629),
							rot=(-0.0, 0.0, 0.0, 1.0),
						),
					)
	countertop_base_cabinet_1 = RigidObjectCfg(
						prim_path="{ENV_REGEX_NS}/Kitchen/countertop_base_cabinet_1",
						spawn=None,
						init_state=RigidObjectCfg.InitialStateCfg(
							pos=(-0.9499, -0.9035, 0.7629),
							rot=(0.7071, 0.0, 0.0, 0.7071),
						),
					)
	countertop_corner_1 = RigidObjectCfg(
						prim_path="{ENV_REGEX_NS}/Kitchen/countertop_corner_1",
						spawn=None,
						init_state=RigidObjectCfg.InitialStateCfg(
							pos=(1.8149, -0.035, 0.7629),
							rot=(1.0, 0.0, 0.0, 0.0),
						),
					)
	countertop_corner_2 = RigidObjectCfg(
						prim_path="{ENV_REGEX_NS}/Kitchen/countertop_corner_2",
						spawn=None,
						init_state=RigidObjectCfg.InitialStateCfg(
							pos=(1.8149, -2.3428, 0.7629),
							rot=(-0.7071, 0.0, 0.0, 0.7071),
						),
					)
	countertop_corner_3 = RigidObjectCfg(
						prim_path="{ENV_REGEX_NS}/Kitchen/countertop_corner_3",
						spawn=None,
						init_state=RigidObjectCfg.InitialStateCfg(
							pos=(-0.9149, -0.035, 0.7629),
							rot=(1.0, 0.0, 0.0, 0.0),
						),
					)
	...
	mug = RigidObjectCfg(
						...
						spawn=None,
						init_state=RigidObjectCfg.InitialStateCfg(
							pos=(0.4758, -0.3539, 0.7818),
							rot=(0.7184, 0.0, 0.0, -0.6956),
						),
					)
	obj0 = RigidObjectCfg(
						...
						spawn=None,
						init_state=RigidObjectCfg.InitialStateCfg(
							pos=(0.6559, -0.3314, 0.7828),
							rot=(0.9247, 0.0, 0.0, -0.3807),
						),
					)
	plate = RigidObjectCfg(
						...
						spawn=None,
						init_state=RigidObjectCfg.InitialStateCfg(
							pos=(1.5316, -0.5076, 0.7818),
							rot=(0.9964, 0.0, 0.0, -0.0844),
						),
					)
...
class TerminationsCfg:
	...
	success = DoneTerm(
			func=mdp.sink,
			params={"obj_cfg": SceneEntityCfg("obj0")}
			)
