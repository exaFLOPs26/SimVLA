...
# -------Change-------
	...
	kitchen = AssetBaseCfg(
		...
		spawn=sim_utils.UsdFileCfg(usd_path="file:/root/IsaacLab/source/isaaclab_assets/data/Kitchen/kitchen_10.usd"),
	)
	apple0 = RigidObjectCfg(
						prim_path="{ENV_REGEX_NS}/Kitchen/apple0",
						spawn=None,
						init_state=RigidObjectCfg.InitialStateCfg(
							pos=(-0.2882, -0.1533, 0.5778),
	...
	bottle0 = RigidObjectCfg(
						...
						spawn=None,
						init_state=RigidObjectCfg.InitialStateCfg(
							pos=(0.7343, -0.3471, 0.952),
							rot=(0.9298, 0.0, 0.0, -0.3681),
						),
					)
