...
# -------Change-------
	...
	kitchen = AssetBaseCfg(
		...
		spawn=sim_utils.UsdFileCfg(usd_path="file:/root/IsaacLab/source/isaaclab_assets/data/Kitchen/kitchen_100_10.usd"),
	)
	apple0 = RigidObjectCfg(
						prim_path="{ENV_REGEX_NS}/Kitchen/apple0",
						spawn=None,
						init_state=RigidObjectCfg.InitialStateCfg(
							pos=(1.2819, -2.7905, 0.9535),
							rot=(-0.7071, 0.0, 0.0, 0.7071),
						),
					)
	apple1 = RigidObjectCfg(
						prim_path="{ENV_REGEX_NS}/Kitchen/apple1",
						spawn=None,
						init_state=RigidObjectCfg.InitialStateCfg(
							pos=(1.2806, -2.3626, 0.9535),
							rot=(-0.7071, 0.0, 0.0, 0.7071),
						),
					)
	apple2 = RigidObjectCfg(
						prim_path="{ENV_REGEX_NS}/Kitchen/apple2",
						spawn=None,
						init_state=RigidObjectCfg.InitialStateCfg(
							pos=(1.2842, -2.5036, 0.9535),
							rot=(-0.7071, 0.0, 0.0, 0.7071),
						),
					)
	apple3 = RigidObjectCfg(
						prim_path="{ENV_REGEX_NS}/Kitchen/apple3",
						spawn=None,
						init_state=RigidObjectCfg.InitialStateCfg(
							pos=(1.3234, -2.7271, 0.7256),
							rot=(-0.7071, 0.0, 0.0, 0.7071),
						),
					)
	base_cabinet = ArticulationCfg(
						...
						init_state=ArticulationCfg.InitialStateCfg(
							pos=(1.4816, -1.727, 0.0),
							rot=(-0.7071, 0.0, 0.0, 0.7071),
							joint_pos={'corpus_to_drawer_0_0': 0.0},
						),
							actuators={
	...
	bowl0 = RigidObjectCfg(
						prim_path="{ENV_REGEX_NS}/Kitchen/bowl0",
						spawn=None,
						init_state=RigidObjectCfg.InitialStateCfg(
							pos=(-0.229, -0.3178, 0.952),
							rot=(1.0, 0.0, 0.0, 0.0),
						),
					)
	corner = RigidObjectCfg(
						prim_path="{ENV_REGEX_NS}/Kitchen/corner",
						spawn=None,
						init_state=RigidObjectCfg.InitialStateCfg(
							pos=(1.4466, -0.035, 0.4527),
							rot=(1.0, 0.0, 0.0, 0.0),
						),
					)
	countertop_base_cabinet = RigidObjectCfg(
						prim_path="{ENV_REGEX_NS}/Kitchen/countertop_base_cabinet",
						spawn=None,
						init_state=RigidObjectCfg.InitialStateCfg(
							pos=(1.4816, -1.727, 0.9277),
							rot=(-0.7071, 0.0, 0.0, 0.7071),
						),
					)
	countertop_corner = RigidObjectCfg(
						prim_path="{ENV_REGEX_NS}/Kitchen/countertop_corner",
						spawn=None,
						init_state=RigidObjectCfg.InitialStateCfg(
							pos=(1.4466, -0.035, 0.9277),
							rot=(1.0, 0.0, 0.0, 0.0),
						),
					)
	countertop_dishwasher = RigidObjectCfg(
	...
	kitchen_island = ArticulationCfg(
						prim_path="{ENV_REGEX_NS}/Kitchen/kitchen_island",
						spawn=None,
						init_state=ArticulationCfg.InitialStateCfg(
							pos=(0.1507, -2.4644, 0.0),
							rot=(0.7071, 0.0, 0.0, 0.7071),
							joint_pos={'corpus_to_door_0_1': 0.0, 'corpus_to_door_1_1': 0.0, 'corpus_to_drawer_0_0': 0.0, 'corpus_to_drawer_1_0': 0.0},
						),
							actuators={
								"default": ImplicitActuatorCfg(
									joint_names_expr=["corpus_to_door_0_1", "corpus_to_door_1_1", "corpus_to_drawer_0_0", "corpus_to_drawer_1_0"],
									effort_limit=87.0,
									velocity_limit=100.0,
									stiffness=0.0,
									damping=1.0,
	...
	mug0 = RigidObjectCfg(
						prim_path="{ENV_REGEX_NS}/Kitchen/mug0",
						spawn=None,
						init_state=RigidObjectCfg.InitialStateCfg(
							pos=(0.4059, -2.8903, 0.952),
							rot=(0.866, 0.0, 0.0, -0.5),
						),
					)
	...
	range_hood = RigidObjectCfg(
						prim_path="{ENV_REGEX_NS}/Kitchen/range_hood",
						spawn=None,
						init_state=RigidObjectCfg.InitialStateCfg(
							pos=(1.608, -0.8473, 1.3482),
							rot=(-0.7071, 0.0, 0.0, 0.7071),
						),
					)
	...
	sodacan0 = RigidObjectCfg(
						prim_path="{ENV_REGEX_NS}/Kitchen/sodacan0",
						spawn=None,
						init_state=RigidObjectCfg.InitialStateCfg(
							pos=(1.3097, -2.4128, 0.7256),
							rot=(-0.7071, 0.0, 0.0, 0.7071),
						),
					)
	...
	wall_cabinet_2 = ArticulationCfg(
						...
						spawn=None,
						init_state=ArticulationCfg.InitialStateCfg(
							pos=(1.2303, 0.1988, 1.3482),
							rot=(1.0, 0.0, 0.0, 0.0),
							joint_pos={'corpus_to_door_0_0': 0.0},
						),
							actuators={
								"default": ImplicitActuatorCfg(
									joint_names_expr=["corpus_to_door_0_0"],
									effort_limit=87.0,
									velocity_limit=100.0,
									stiffness=0.0,
									damping=1.0,
