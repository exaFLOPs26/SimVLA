...
# -------Change-------
	...
	kitchen = AssetBaseCfg(
		...
		spawn=sim_utils.UsdFileCfg(usd_path="file:/root/IsaacLab/source/isaaclab_assets/data/Kitchen/kitchen_1021_00.usd"),
	)
	...
	mug0 = RigidObjectCfg(prim_path="{ENV_REGEX_NS}/Kitchen/mug0",spawn=None,init_state=RigidObjectCfg.InitialStateCfg(pos=(0.4413, -0.3014, 0.952), rot=(1.0, 0.0, 0.0, 0.0)))
