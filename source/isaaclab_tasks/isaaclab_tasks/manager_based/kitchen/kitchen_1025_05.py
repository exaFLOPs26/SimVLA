...
from isaaclab.sim.spawners import RigidObjectSpawnerCfg
...
# -------Change-------
	...
	kitchen = AssetBaseCfg(
		...
		spawn=sim_utils.UsdFileCfg(usd_path="file:/root/IsaacLab/source/isaaclab_assets/data/Kitchen/kitchen_1025_05.usd"),
	)
	base_cabinet = ArticulationCfg(prim_path="{ENV_REGEX_NS}/Kitchen/base_cabinet",spawn=None,init_state=ArticulationCfg.InitialStateCfg(pos=(1.4051, -1.6429, 0.0), rot=(-0.7071, 0.0, 0.0, 0.7071), joint_pos={'corpus_to_drawer_0_0': 0.0, 'corpus_to_drawer_0_1': 0.0, 'corpus_to_drawer_0_2': 0.0}),
						actuators={
	...
	bottle0 = RigidObjectCfg(prim_path="{ENV_REGEX_NS}/Kitchen/bottle0",spawn=None,init_state=RigidObjectCfg.InitialStateCfg(pos=(1.167, -1.2756, 0.952), rot=(0.2588, 0.0, 0.0, 0.9659)))
	countertop_base_cabinet = RigidObjectCfg(prim_path="{ENV_REGEX_NS}/Kitchen/countertop_base_cabinet",spawn=None,init_state=RigidObjectCfg.InitialStateCfg(pos=(1.4051, -1.6429, 0.9251), rot=(-0.7071, 0.0, 0.0, 0.7071)))
	countertop_corner = RigidObjectCfg(prim_path="{ENV_REGEX_NS}/Kitchen/countertop_corner",spawn=None,init_state=RigidObjectCfg.InitialStateCfg(pos=(1.3701, -0.035, 0.9251), rot=(1.0, 0.0, 0.0, 0.0)))
	countertop_dishwasher = RigidObjectCfg(prim_path="{ENV_REGEX_NS}/Kitchen/countertop_dishwasher",spawn=None,init_state=RigidObjectCfg.InitialStateCfg(pos=(0.6577, 0.0, 0.9251), rot=(1.0, 0.0, 0.0, 0.0)))
	dishwasher = ArticulationCfg(prim_path="{ENV_REGEX_NS}/Kitchen/dishwasher",spawn=None,init_state=ArticulationCfg.InitialStateCfg(pos=(0.6577, 0.0, 0.0), rot=(1.0, 0.0, 0.0, 0.0), joint_pos={'corpse_to_bottom_basket': 0.0, 'corpse_to_top_basket': 0.0, 'corpus_to_door_0_1': 0.0}),
						actuators={
	...
	range_hood = RigidObjectCfg(prim_path="{ENV_REGEX_NS}/Kitchen/range_hood",spawn=None,init_state=RigidObjectCfg.InitialStateCfg(pos=(0.0, 0.0572, 1.2585), rot=(1.0, 0.0, 0.0, 0.0)))
	refrigerator = ArticulationCfg(prim_path="{ENV_REGEX_NS}/Kitchen/refrigerator",spawn=None,init_state=ArticulationCfg.InitialStateCfg(pos=(1.3897, -2.5648, 0.0), rot=(-0.7071, 0.0, 0.0, 0.7071), joint_pos={'door_joint': 0.0, 'freezer_door_joint': 0.0}),
						actuators={
	...
	sink_cabinet = ArticulationCfg(prim_path="{ENV_REGEX_NS}/Kitchen/sink_cabinet",spawn=None,init_state=ArticulationCfg.InitialStateCfg(pos=(1.4051, -0.7834, 0.0), rot=(-0.7071, 0.0, 0.0, 0.7071), joint_pos={'corpus_to_door_0_1': 0.0, 'corpus_to_door_1_1': 0.0}),
						actuators={
	...
	wall_cabinet = ArticulationCfg(prim_path="{ENV_REGEX_NS}/Kitchen/wall_cabinet",spawn=None,init_state=ArticulationCfg.InitialStateCfg(pos=(1.5821, -1.6429, 1.2585), rot=(-0.7071, 0.0, 0.0, 0.7071), joint_pos={'corpus_to_door_0_0': 0.0, 'corpus_to_door_1_0': 0.0}),
						actuators={
	...
	wall_cabinet_0 = ArticulationCfg(prim_path="{ENV_REGEX_NS}/Kitchen/wall_cabinet_0",spawn=None,init_state=ArticulationCfg.InitialStateCfg(pos=(0.6577, 0.177, 1.2585), rot=(1.0, 0.0, 0.0, 0.0), joint_pos={'corpus_to_door_0_0': 0.0, 'corpus_to_door_1_0': 0.0}),
						actuators={
							"default": ImplicitActuatorCfg(joint_names_expr=["corpus_to_door_0_0", "corpus_to_door_1_0"],effort_limit=87.0,velocity_limit=100.0,stiffness=0.0,damping=1.0)
							})
	wall_cabinet_1 = ArticulationCfg(prim_path="{ENV_REGEX_NS}/Kitchen/wall_cabinet_1",spawn=None,init_state=ArticulationCfg.InitialStateCfg(pos=(1.5821, -0.7834, 1.2585), rot=(-0.7071, 0.0, 0.0, 0.7071), joint_pos={'corpus_to_door_0_0': 0.0, 'corpus_to_door_1_0': 0.0}),
						actuators={
							"default": ImplicitActuatorCfg(joint_names_expr=["corpus_to_door_0_0", "corpus_to_door_1_0"],effort_limit=87.0,velocity_limit=100.0,stiffness=0.0,damping=1.0)
							})
	wall_cabinet_2 = ArticulationCfg(prim_path="{ENV_REGEX_NS}/Kitchen/wall_cabinet_2",spawn=None,init_state=ArticulationCfg.InitialStateCfg(pos=(1.1757, 0.177, 1.2585), rot=(1.0, 0.0, 0.0, 0.0), joint_pos={'corpus_to_door_0_0': 0.0}),
						actuators={
	...
	wall_cabinet_3 = ArticulationCfg(prim_path="{ENV_REGEX_NS}/Kitchen/wall_cabinet_3",spawn=None,init_state=ArticulationCfg.InitialStateCfg(pos=(1.5821, -0.2295, 1.2585), rot=(1.0, 0.0, 0.0, 0.0), joint_pos={'corpus_to_door_0_0': 0.0}),
						actuators={
							"default": ImplicitActuatorCfg(joint_names_expr=["corpus_to_door_0_0"],effort_limit=87.0,velocity_limit=100.0,stiffness=0.0,damping=1.0)
							})
	wall_01 = AssetBaseCfg(
		prim_path="{ENV_REGEX_NS}/wall_01",
		init_state=AssetBaseCfg.InitialStateCfg(pos=(0.712, -3.187, 1.500), rot=(0.70711, 0.70711, 0.0, 0.0)),
		spawn=sim_utils.UsdFileCfg(
			usd_path="file:/root/IsaacLab/source/isaaclab_assets/data/floor.usd",
			scale=(2.493, 3.0, 0.1),
	...
	wall_02 = AssetBaseCfg(
		...
		init_state=AssetBaseCfg.InitialStateCfg(pos=(1.959, -1.316, 1.500), rot=(0.5, 0.5, 0.5, 0.5)),
		spawn=sim_utils.UsdFileCfg(
			usd_path="file:/root/IsaacLab/source/isaaclab_assets/data/floor.usd",
			scale=(3.741, 3.0, 0.1),
			visual_material=MdlFileCfg(mdl_path=wall_material),
	...
	wall_03 = AssetBaseCfg(
		...
		init_state=AssetBaseCfg.InitialStateCfg(pos=(-0.534, -1.316, 1.500), rot=(0.5, 0.5, 0.5, 0.5)),
		spawn=sim_utils.UsdFileCfg(
			usd_path="file:/root/IsaacLab/source/isaaclab_assets/data/floor.usd",
			scale=(3.741, 3.0, 0.1),
			visual_material=MdlFileCfg(mdl_path=wall_material),
	...
	wall_04 = AssetBaseCfg(
		...
		init_state=AssetBaseCfg.InitialStateCfg(pos=(0.712, 0.554, 1.500), rot=(0.70711, 0.70711, 0.0, 0.0)),
		spawn=sim_utils.UsdFileCfg(
			usd_path="file:/root/IsaacLab/source/isaaclab_assets/data/floor.usd",
			scale=(2.493, 3.0, 0.1),
			visual_material=MdlFileCfg(mdl_path=wall_material),
