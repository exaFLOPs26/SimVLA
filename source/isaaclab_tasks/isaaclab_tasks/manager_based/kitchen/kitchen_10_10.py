...
# -------Change-------
	...
	kitchen = AssetBaseCfg(
		...
		spawn=sim_utils.UsdFileCfg(usd_path="file:/root/IsaacLab/source/isaaclab_assets/data/Kitchen/kitchen_10_10.usd"),
	)
	apple0 = RigidObjectCfg(
						prim_path="{ENV_REGEX_NS}/Kitchen/apple0",
						spawn=None,
						init_state=RigidObjectCfg.InitialStateCfg(
							pos=(-0.2882, -0.1533, 0.5778)kitchen_sub_num,
							rot=(0.7675, 0.0, 0.0, -0.6411),
						),
					)
	...
	bottle0 = RigidObjectCfg(
						...
						spawn=None,
						init_state=RigidObjectCfg.InitialStateCfg(
							pos=(0.7343, -0.3471, 0.952)kitchen_sub_num,
	...
	corner = RigidObjectCfg(
						...
						spawn=None,
						init_state=RigidObjectCfg.InitialStateCfg(
							pos=(2.5278, -0.0499, 0.4517)kitchen_sub_num,
							rot=(1.0, 0.0, 0.0, 0.0),
						),
					)
	countertop_base_cabinet = RigidObjectCfg(
						...
						spawn=None,
						init_state=RigidObjectCfg.InitialStateCfg(
							pos=(0.9259, -0.0149, 0.9267)kitchen_sub_num,
							rot=(1.0, 0.0, 0.0, 0.0),
						),
					)
	countertop_corner = RigidObjectCfg(
						...
						spawn=None,
						init_state=RigidObjectCfg.InitialStateCfg(
							pos=(2.5278, -0.0499, 0.9267)kitchen_sub_num,
							rot=(1.0, 0.0, 0.0, 0.0),
						),
					)
	countertop_dishwasher = RigidObjectCfg(
						...
						spawn=None,
						init_state=RigidObjectCfg.InitialStateCfg(
							pos=(1.763, -0.0149, 0.9267)kitchen_sub_num,
							rot=(1.0, 0.0, 0.0, 0.0),
						),
					)
	...
	range_hood = RigidObjectCfg(
						...
						spawn=None,
						init_state=RigidObjectCfg.InitialStateCfg(
							pos=(2.6912, -1.6175, 1.2932)kitchen_sub_num,
							rot=(-0.7071, 0.0, 0.0, 0.7071),
						),
					)
