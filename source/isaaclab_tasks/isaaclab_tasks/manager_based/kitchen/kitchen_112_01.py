...
# -------Change-------
	...
	kitchen = AssetBaseCfg(
		...
		spawn=sim_utils.UsdFileCfg(usd_path="file:/root/IsaacLab/source/isaaclab_assets/data/Kitchen/kitchen_112_01.usd"),
	)
	base_cabinet = ArticulationCfg(prim_path="{ENV_REGEX_NS}/Kitchen/base_cabinet",spawn=None,init_state=ArticulationCfg.InitialStateCfg(pos=(0.8698, 0.0334, 0.0), rot=(1.0, 0.0, 0.0, 0.0), joint_pos={'corpus_to_drawer_0_0': 0.0, 'corpus_to_drawer_0_1': 0.0}),
						actuators={
	...
	bottle0 = RigidObjectCfg(prim_path="{ENV_REGEX_NS}/Kitchen/bottle0",spawn=None,init_state=RigidObjectCfg.InitialStateCfg(pos=(0.476, -0.2803, 0.952), rot=(0.9659, 0.0, 0.0, 0.2588)))
	corner = RigidObjectCfg(prim_path="{ENV_REGEX_NS}/Kitchen/corner",spawn=None,init_state=RigidObjectCfg.InitialStateCfg(pos=(1.7913, -0.0016, 0.4564), rot=(1.0, 0.0, 0.0, 0.0)))
	countertop_base_cabinet = RigidObjectCfg(prim_path="{ENV_REGEX_NS}/Kitchen/countertop_base_cabinet",spawn=None,init_state=RigidObjectCfg.InitialStateCfg(pos=(0.8698, 0.0334, 0.9314), rot=(1.0, 0.0, 0.0, 0.0)))
	countertop_corner = RigidObjectCfg(prim_path="{ENV_REGEX_NS}/Kitchen/countertop_corner",spawn=None,init_state=RigidObjectCfg.InitialStateCfg(pos=(1.7913, -0.0016, 0.9314), rot=(1.0, 0.0, 0.0, 0.0)))
	countertop_dishwasher = RigidObjectCfg(prim_path="{ENV_REGEX_NS}/Kitchen/countertop_dishwasher",spawn=None,init_state=RigidObjectCfg.InitialStateCfg(pos=(1.8263, -1.5951, 0.9314), rot=(-0.7071, 0.0, 0.0, 0.7071)))
	dishwasher = ArticulationCfg(prim_path="{ENV_REGEX_NS}/Kitchen/dishwasher",spawn=None,init_state=ArticulationCfg.InitialStateCfg(pos=(1.8263, -1.5951, 0.0), rot=(-0.7071, 0.0, 0.0, 0.7071), joint_pos={'corpse_to_bottom_basket': 0.0, 'corpse_to_top_basket': 0.0, 'corpus_to_door_0_1': 0.0}),
						actuators={
	...
	range = ArticulationCfg(prim_path="{ENV_REGEX_NS}/Kitchen/range",spawn=None,init_state=ArticulationCfg.InitialStateCfg(pos=(1.8263, -2.3349, 0.0), rot=(-0.7071, 0.0, 0.0, 0.7071), joint_pos={'corpus_to_door_0_1': 0.0, 'corpus_to_drawer_0_2': 0.0}),
						actuators={
	...
	range_hood = RigidObjectCfg(prim_path="{ENV_REGEX_NS}/Kitchen/range_hood",spawn=None,init_state=RigidObjectCfg.InitialStateCfg(pos=(1.9567, -2.3349, 1.3243), rot=(-0.7071, 0.0, 0.0, 0.7071)))
	...
	sink_cabinet = ArticulationCfg(prim_path="{ENV_REGEX_NS}/Kitchen/sink_cabinet",spawn=None,init_state=ArticulationCfg.InitialStateCfg(pos=(1.8263, -0.8414, 0.0), rot=(-0.7071, 0.0, 0.0, 0.7071), joint_pos={'corpus_to_door_0_1': 0.0, 'corpus_to_door_1_1': 0.0}),
						actuators={
	...
	wall_cabinet = ArticulationCfg(prim_path="{ENV_REGEX_NS}/Kitchen/wall_cabinet",spawn=None,init_state=ArticulationCfg.InitialStateCfg(pos=(0.8698, 0.2267, 1.3243), rot=(1.0, 0.0, 0.0, 0.0), joint_pos={'corpus_to_door_0_0': 0.0, 'corpus_to_door_1_0': 0.0}),
						actuators={
	...
	wall_cabinet_0 = ArticulationCfg(prim_path="{ENV_REGEX_NS}/Kitchen/wall_cabinet_0",spawn=None,init_state=ArticulationCfg.InitialStateCfg(pos=(2.0196, -1.5951, 1.3243), rot=(-0.7071, 0.0, 0.0, 0.7071), joint_pos={'corpus_to_door_0_0': 0.0, 'corpus_to_door_1_0': 0.0}),
						actuators={
							"default": ImplicitActuatorCfg(joint_names_expr=["corpus_to_door_0_0", "corpus_to_door_1_0"],effort_limit=87.0,velocity_limit=100.0,stiffness=0.0,damping=1.0)
							})
	wall_cabinet_1 = ArticulationCfg(prim_path="{ENV_REGEX_NS}/Kitchen/wall_cabinet_1",spawn=None,init_state=ArticulationCfg.InitialStateCfg(pos=(2.0196, -0.8414, 1.3243), rot=(-0.7071, 0.0, 0.0, 0.7071), joint_pos={'corpus_to_door_0_0': 0.0, 'corpus_to_door_1_0': 0.0}),
						actuators={
							"default": ImplicitActuatorCfg(joint_names_expr=["corpus_to_door_0_0", "corpus_to_door_1_0"],effort_limit=87.0,velocity_limit=100.0,stiffness=0.0,damping=1.0)
							})
	wall_cabinet_2 = ArticulationCfg(prim_path="{ENV_REGEX_NS}/Kitchen/wall_cabinet_2",spawn=None,init_state=ArticulationCfg.InitialStateCfg(pos=(1.5806, 0.2267, 1.3243), rot=(1.0, 0.0, 0.0, 0.0), joint_pos={'corpus_to_door_0_0': 0.0}),
						actuators={
	...
	wall_cabinet_3 = ArticulationCfg(prim_path="{ENV_REGEX_NS}/Kitchen/wall_cabinet_3",spawn=None,init_state=ArticulationCfg.InitialStateCfg(pos=(2.0196, -0.2123, 1.3243), rot=(1.0, 0.0, 0.0, 0.0), joint_pos={'corpus_to_door_0_0': 0.0}),
						actuators={
							"default": ImplicitActuatorCfg(joint_names_expr=["corpus_to_door_0_0"],effort_limit=87.0,velocity_limit=100.0,stiffness=0.0,damping=1.0)
							})
	wall_01 = AssetBaseCfg(
		prim_path="{ENV_REGEX_NS}/wall_01",
		init_state=AssetBaseCfg.InitialStateCfg(pos=(0.922, -2.939, 1.500), rot=(0.70711, 0.70711, 0.0, 0.0)),
		spawn=sim_utils.UsdFileCfg(
			usd_path="file:/root/IsaacLab/source/isaaclab_assets/data/floor.usd",
			scale=(2.983, 3.0, 0.1),
	...
	wall_02 = AssetBaseCfg(
		...
		init_state=AssetBaseCfg.InitialStateCfg(pos=(2.413, -1.160, 1.500), rot=(0.5, 0.5, 0.5, 0.5)),
		spawn=sim_utils.UsdFileCfg(
			usd_path="file:/root/IsaacLab/source/isaaclab_assets/data/floor.usd",
			scale=(3.559, 3.0, 0.1),
			visual_material=MdlFileCfg(mdl_path=wall_material),
	...
	wall_03 = AssetBaseCfg(
		...
		init_state=AssetBaseCfg.InitialStateCfg(pos=(-0.570, -1.160, 1.500), rot=(0.5, 0.5, 0.5, 0.5)),
		spawn=sim_utils.UsdFileCfg(
			usd_path="file:/root/IsaacLab/source/isaaclab_assets/data/floor.usd",
			scale=(3.559, 3.0, 0.1),
			visual_material=MdlFileCfg(mdl_path=wall_material),
	...
	wall_04 = AssetBaseCfg(
		...
		init_state=AssetBaseCfg.InitialStateCfg(pos=(0.922, 0.620, 1.500), rot=(0.70711, 0.70711, 0.0, 0.0)),
		spawn=sim_utils.UsdFileCfg(
			usd_path="file:/root/IsaacLab/source/isaaclab_assets/data/floor.usd",
			scale=(2.983, 3.0, 0.1),
			visual_material=MdlFileCfg(mdl_path=wall_material),
