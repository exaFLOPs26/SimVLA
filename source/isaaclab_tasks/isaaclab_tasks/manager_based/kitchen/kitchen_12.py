...
# -------Change-------
	...
	kitchen = AssetBaseCfg(
		...
		spawn=sim_utils.UsdFileCfg(usd_path="file:/root/IsaacLab/source/isaaclab_assets/data/Kitchen/kitchen_12.usd"),
	)
	base_cabinet = ArticulationCfg(
						prim_path="{ENV_REGEX_NS}/Kitchen/base_cabinet",
						spawn=None,
						init_state=ArticulationCfg.InitialStateCfg(
							pos=(0.8639, 0.0079, 0.0),
							rot=(1.0, 0.0, 0.0, 0.0),
	...
	bottle0 = RigidObjectCfg(
						...
						init_state=RigidObjectCfg.InitialStateCfg(
							pos=(0.4749, -0.3344, 0.7626),
							rot=(0.8018, 0.0, 0.0, 0.5976),
						),
					)
