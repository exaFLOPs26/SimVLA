...
# -------Change-------
	...
	kitchen = AssetBaseCfg(
		...
		spawn=sim_utils.UsdFileCfg(usd_path="file:/root/IsaacLab/source/isaaclab_assets/data/Kitchen/kitchen_14.usd"),
	)
	...
	bottle0 = RigidObjectCfg(
						...
						init_state=RigidObjectCfg.InitialStateCfg(
							pos=(-0.3631, -0.3523, 0.7972),
							rot=(-0.522, 0.0, 0.0, 0.853),
						),
					)
