...
# -------Change-------
	...
	kitchen = AssetBaseCfg(
		...
		spawn=sim_utils.UsdFileCfg(usd_path="file:/root/IsaacLab/source/isaaclab_assets/data/Kitchen/kitchen_17.usd"),
	)
	base_cabinet = ArticulationCfg(
						prim_path="{ENV_REGEX_NS}/Kitchen/base_cabinet",
						spawn=None,
						init_state=ArticulationCfg.InitialStateCfg(
							pos=(0.9104, -0.0014, 0.0),
							rot=(1.0, 0.0, 0.0, 0.0),
	...
	bottle0 = RigidObjectCfg(
						...
						init_state=RigidObjectCfg.InitialStateCfg(
							pos=(0.4711, -0.3224, 0.952),
							rot=(-0.5171, 0.0, 0.0, 0.8559),
						),
					)
