...
# -------Change-------
	...
	kitchen = AssetBaseCfg(
		...
		spawn=sim_utils.UsdFileCfg(usd_path="file:/root/IsaacLab/source/isaaclab_assets/data/Kitchen/kitchen_31_10.usd"),
	)
	base_cabinet = ArticulationCfg(
						prim_path="{ENV_REGEX_NS}/Kitchen/base_cabinet",
						spawn=None,
						init_state=ArticulationCfg.InitialStateCfg(
							pos=(1.5659, -0.9427, 0.0),
							rot=(-0.7071, 0.0, 0.0, 0.7071),
							joint_pos={'corpus_to_door_0_1': 0.0, 'corpus_to_door_1_1': 0.0, 'corpus_to_door_2_1': 0.0, 'corpus_to_drawer_0_0': 0.0},
						),
							actuators={
								"default": ImplicitActuatorCfg(
									joint_names_expr=["corpus_to_door_0_1", "corpus_to_door_1_1", "corpus_to_door_2_1", "corpus_to_drawer_0_0"],
									effort_limit=87.0,
