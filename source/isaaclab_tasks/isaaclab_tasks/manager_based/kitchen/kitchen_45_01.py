...
# -------Change-------
	...
	kitchen = AssetBaseCfg(
		...
		spawn=sim_utils.UsdFileCfg(usd_path="file:/root/IsaacLab/source/isaaclab_assets/data/Kitchen/kitchen_45_01.usd"),
	)
	base_cabinet = ArticulationCfg(prim_path="{ENV_REGEX_NS}/Kitchen/base_cabinet",spawn=None,init_state=ArticulationCfg.InitialStateCfg(pos=(1.4689, -1.639, 0.0), rot=(-0.7071, 0.0, 0.0, 0.7071), joint_pos={'corpus_to_door_0_2': 0.0, 'corpus_to_door_1_2': 0.0, 'corpus_to_door_2_2': 0.0, 'corpus_to_drawer_0_0': 0.0, 'corpus_to_drawer_0_1': 0.0, 'corpus_to_drawer_1_0': 0.0, 'corpus_to_drawer_1_1': 0.0, 'corpus_to_drawer_2_0': 0.0, 'corpus_to_drawer_2_1': 0.0}),
						actuators={
	...
	bottle0 = RigidObjectCfg(prim_path="{ENV_REGEX_NS}/Kitchen/bottle0",spawn=None,init_state=RigidObjectCfg.InitialStateCfg(pos=(1.158, -1.198, 0.952), rot=(-0.7071, 0.0, 0.0, 0.7071)))
	bottle1 = RigidObjectCfg(prim_path="{ENV_REGEX_NS}/Kitchen/bottle1",spawn=None,init_state=RigidObjectCfg.InitialStateCfg(pos=(-0.2893, -0.3219, 0.952), rot=(1.0, 0.0, 0.0, 0.0)))
	bowl0 = RigidObjectCfg(prim_path="{ENV_REGEX_NS}/Kitchen/bowl0",spawn=None,init_state=RigidObjectCfg.InitialStateCfg(pos=(-0.0728, -0.2801, 0.952), rot=(1.0, 0.0, 0.0, 0.0)))
	corner = RigidObjectCfg(prim_path="{ENV_REGEX_NS}/Kitchen/corner",spawn=None,init_state=RigidObjectCfg.InitialStateCfg(pos=(1.4339, -0.035, 0.458), rot=(1.0, 0.0, 0.0, 0.0)))
	countertop_base_cabinet = RigidObjectCfg(prim_path="{ENV_REGEX_NS}/Kitchen/countertop_base_cabinet",spawn=None,init_state=RigidObjectCfg.InitialStateCfg(pos=(1.4689, -1.639, 0.933), rot=(-0.7071, 0.0, 0.0, 0.7071)))
	countertop_corner = RigidObjectCfg(prim_path="{ENV_REGEX_NS}/Kitchen/countertop_corner",spawn=None,init_state=RigidObjectCfg.InitialStateCfg(pos=(1.4339, -0.035, 0.933), rot=(1.0, 0.0, 0.0, 0.0)))
	countertop_dishwasher = RigidObjectCfg(prim_path="{ENV_REGEX_NS}/Kitchen/countertop_dishwasher",spawn=None,init_state=RigidObjectCfg.InitialStateCfg(pos=(0.0, 0.0, 0.933), rot=(1.0, 0.0, 0.0, 0.0)))
	...
	mug0 = RigidObjectCfg(prim_path="{ENV_REGEX_NS}/Kitchen/mug0",spawn=None,init_state=RigidObjectCfg.InitialStateCfg(pos=(1.1644, -1.3053, 0.952), rot=(0.9659, 0.0, 0.0, 0.2588)))
	range = ArticulationCfg(prim_path="{ENV_REGEX_NS}/Kitchen/range",spawn=None,init_state=ArticulationCfg.InitialStateCfg(pos=(1.4689, -0.7954, 0.0), rot=(-0.7071, 0.0, 0.0, 0.7071), joint_pos={'corpus_to_door_0_1': 0.0, 'corpus_to_drawer_0_2': 0.0}),
						actuators={
	...
	range_hood = RigidObjectCfg(prim_path="{ENV_REGEX_NS}/Kitchen/range_hood",spawn=None,init_state=RigidObjectCfg.InitialStateCfg(pos=(1.5459, -0.7954, 1.3288), rot=(-0.7071, 0.0, 0.0, 0.7071)))
	refrigerator = ArticulationCfg(prim_path="{ENV_REGEX_NS}/Kitchen/refrigerator",spawn=None,init_state=ArticulationCfg.InitialStateCfg(pos=(1.4559, -2.5292, 0.0), rot=(-0.7071, 0.0, 0.0, 0.7071), joint_pos={'door_joint': 0.0, 'freezer_door_joint': 0.0}),
						actuators={
	...
	sink_cabinet = ArticulationCfg(prim_path="{ENV_REGEX_NS}/Kitchen/sink_cabinet",spawn=None,init_state=ArticulationCfg.InitialStateCfg(pos=(0.6708, 0.0, 0.0), rot=(1.0, 0.0, 0.0, 0.0), joint_pos={'corpus_to_door_0_1': 0.0, 'corpus_to_door_1_1': 0.0}),
						actuators={
	...
	sodacan0 = RigidObjectCfg(prim_path="{ENV_REGEX_NS}/Kitchen/sodacan0",spawn=None,init_state=RigidObjectCfg.InitialStateCfg(pos=(1.2821, -2.2579, 0.8305), rot=(-0.7071, 0.0, 0.0, 0.7071)))
	sodacan1 = RigidObjectCfg(prim_path="{ENV_REGEX_NS}/Kitchen/sodacan1",spawn=None,init_state=RigidObjectCfg.InitialStateCfg(pos=(1.2616, -2.3423, 0.8305), rot=(-0.7071, 0.0, 0.0, 0.7071)))
	sodacan2 = RigidObjectCfg(prim_path="{ENV_REGEX_NS}/Kitchen/sodacan2",spawn=None,init_state=RigidObjectCfg.InitialStateCfg(pos=(1.2644, -2.6451, 0.8305), rot=(-0.7071, 0.0, 0.0, 0.7071)))
	sodacan3 = RigidObjectCfg(prim_path="{ENV_REGEX_NS}/Kitchen/sodacan3",spawn=None,init_state=RigidObjectCfg.InitialStateCfg(pos=(1.261, -2.3255, 1.0934), rot=(-0.7071, 0.0, 0.0, 0.7071)))
	wall_cabinet = ArticulationCfg(prim_path="{ENV_REGEX_NS}/Kitchen/wall_cabinet",spawn=None,init_state=ArticulationCfg.InitialStateCfg(pos=(1.6597, -1.639, 1.3288), rot=(-0.7071, 0.0, 0.0, 0.7071), joint_pos={'corpus_to_door_0_0': 0.0, 'corpus_to_door_1_0': 0.0}),
						actuators={
	...
	wall_cabinet_0 = ArticulationCfg(prim_path="{ENV_REGEX_NS}/Kitchen/wall_cabinet_0",spawn=None,init_state=ArticulationCfg.InitialStateCfg(pos=(0.0, 0.1909, 1.3288), rot=(1.0, 0.0, 0.0, 0.0), joint_pos={'corpus_to_door_0_0': 0.0, 'corpus_to_door_1_0': 0.0}),
						actuators={
							"default": ImplicitActuatorCfg(joint_names_expr=["corpus_to_door_0_0", "corpus_to_door_1_0"],effort_limit=87.0,velocity_limit=100.0,stiffness=0.0,damping=1.0)
							})
	wall_cabinet_1 = ArticulationCfg(prim_path="{ENV_REGEX_NS}/Kitchen/wall_cabinet_1",spawn=None,init_state=ArticulationCfg.InitialStateCfg(pos=(0.6708, 0.1909, 1.3288), rot=(1.0, 0.0, 0.0, 0.0), joint_pos={'corpus_to_door_0_0': 0.0, 'corpus_to_door_1_0': 0.0}),
						actuators={
							"default": ImplicitActuatorCfg(joint_names_expr=["corpus_to_door_0_0", "corpus_to_door_1_0"],effort_limit=87.0,velocity_limit=100.0,stiffness=0.0,damping=1.0)
							})
	wall_cabinet_2 = ArticulationCfg(prim_path="{ENV_REGEX_NS}/Kitchen/wall_cabinet_2",spawn=None,init_state=ArticulationCfg.InitialStateCfg(pos=(1.2255, 0.1909, 1.3288), rot=(1.0, 0.0, 0.0, 0.0), joint_pos={'corpus_to_door_0_0': 0.0}),
						actuators={
	...
	wall_cabinet_3 = ArticulationCfg(prim_path="{ENV_REGEX_NS}/Kitchen/wall_cabinet_3",spawn=None,init_state=ArticulationCfg.InitialStateCfg(pos=(1.6597, -0.2434, 1.3288), rot=(1.0, 0.0, 0.0, 0.0), joint_pos={'corpus_to_door_0_0': 0.0}),
						actuators={
							"default": ImplicitActuatorCfg(joint_names_expr=["corpus_to_door_0_0"],effort_limit=87.0,velocity_limit=100.0,stiffness=0.0,damping=1.0)
							})
	wall_01 = AssetBaseCfg(
	    prim_path="{ENV_REGEX_NS}/wall_01",
	    init_state=AssetBaseCfg.InitialStateCfg(pos=(0.759, -3.119, 1.500), rot=(0.70711, 0.70711, 0.0, 0.0)),
	    spawn=sim_utils.UsdFileCfg(
	        usd_path="file:/root/IsaacLab/source/isaaclab_assets/data/floor.usd",
	        scale=(2.584, 3.0, 0.1),
	...
	wall_02 = AssetBaseCfg(
	    ...
	    init_state=AssetBaseCfg.InitialStateCfg(pos=(2.051, -1.269, 1.500), rot=(0.5, 0.5, 0.5, 0.5)),
	    spawn=sim_utils.UsdFileCfg(
	        usd_path="file:/root/IsaacLab/source/isaaclab_assets/data/floor.usd",
	        scale=(3.701, 3.0, 0.1),
	        visual_material=MdlFileCfg(mdl_path=wall_material),
	...
	wall_03 = AssetBaseCfg(
	    ...
	    init_state=AssetBaseCfg.InitialStateCfg(pos=(-0.533, -1.269, 1.500), rot=(0.5, 0.5, 0.5, 0.5)),
	    spawn=sim_utils.UsdFileCfg(
	        usd_path="file:/root/IsaacLab/source/isaaclab_assets/data/floor.usd",
	        scale=(3.701, 3.0, 0.1),
	        visual_material=MdlFileCfg(mdl_path=wall_material),
	...
	wall_04 = AssetBaseCfg(
	    ...
	    init_state=AssetBaseCfg.InitialStateCfg(pos=(0.759, 0.582, 1.500), rot=(0.70711, 0.70711, 0.0, 0.0)),
	    spawn=sim_utils.UsdFileCfg(
	        usd_path="file:/root/IsaacLab/source/isaaclab_assets/data/floor.usd",
	        scale=(2.584, 3.0, 0.1),
	        visual_material=MdlFileCfg(mdl_path=wall_material),
