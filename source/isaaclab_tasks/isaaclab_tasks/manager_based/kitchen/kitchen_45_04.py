...
# -------Change-------
	...
	kitchen = AssetBaseCfg(
		...
		spawn=sim_utils.UsdFileCfg(usd_path="file:/root/IsaacLab/source/isaaclab_assets/data/Kitchen/kitchen_45_04.usd"),
	)
	...
	mug0 = RigidObjectCfg(prim_path="{ENV_REGEX_NS}/Kitchen/mug0",spawn=None,init_state=RigidObjectCfg.InitialStateCfg(pos=(1.1644, -1.3053, 0.952), rot=(0.5, 0.0, 0.0, 0.866)))
	...
	wall_01 = AssetBaseCfg(
		...
		init_state=AssetBaseCfg.InitialStateCfg(pos=(0.759, -3.119, 3.000), rot=(0.70711, 0.70711, 0.0, 0.0)),
		spawn=sim_utils.UsdFileCfg(
			usd_path="file:/root/IsaacLab/source/isaaclab_assets/data/floor.usd",
			scale=(2.584, 3.0, 0.1),
	...
	wall_02 = AssetBaseCfg(
		...
		init_state=AssetBaseCfg.InitialStateCfg(pos=(2.051, -1.269, 3.000), rot=(0.5, 0.5, 0.5, 0.5)),
		spawn=sim_utils.UsdFileCfg(
			usd_path="file:/root/IsaacLab/source/isaaclab_assets/data/floor.usd",
			scale=(3.701, 3.0, 0.1),
			visual_material=MdlFileCfg(mdl_path=wall_material),
	...
	wall_03 = AssetBaseCfg(
		...
		init_state=AssetBaseCfg.InitialStateCfg(pos=(-0.533, -1.269, 3.000), rot=(0.5, 0.5, 0.5, 0.5)),
		spawn=sim_utils.UsdFileCfg(
			usd_path="file:/root/IsaacLab/source/isaaclab_assets/data/floor.usd",
			scale=(3.701, 3.0, 0.1),
			visual_material=MdlFileCfg(mdl_path=wall_material),
	...
	wall_04 = AssetBaseCfg(
		...
		init_state=AssetBaseCfg.InitialStateCfg(pos=(0.759, 0.582, 3.000), rot=(0.70711, 0.70711, 0.0, 0.0)),
		spawn=sim_utils.UsdFileCfg(
			usd_path="file:/root/IsaacLab/source/isaaclab_assets/data/floor.usd",
			scale=(2.584, 3.0, 0.1),
			visual_material=MdlFileCfg(mdl_path=wall_material),
