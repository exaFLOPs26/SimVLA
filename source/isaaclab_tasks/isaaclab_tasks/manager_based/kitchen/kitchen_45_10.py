...
# -------Change-------
	...
	kitchen = AssetBaseCfg(
		...
		spawn=sim_utils.UsdFileCfg(usd_path="file:/root/IsaacLab/source/isaaclab_assets/data/Kitchen/kitchen_45_10.usd"),
	)
	base_cabinet = ArticulationCfg(
						prim_path="{ENV_REGEX_NS}/Kitchen/base_cabinet",
						spawn=None,
						init_state=ArticulationCfg.InitialStateCfg(
							pos=(1.4689, -1.639, 0.0),
	...
	bottle0 = RigidObjectCfg(
						prim_path="{ENV_REGEX_NS}/Kitchen/bottle0",
						spawn=None,
						init_state=RigidObjectCfg.InitialStateCfg(
							pos=(1.158, -1.198, 0.952),
							rot=(-0.7071, 0.0, 0.0, 0.7071),
						),
					)
	bottle1 = RigidObjectCfg(
						prim_path="{ENV_REGEX_NS}/Kitchen/bottle1",
						spawn=None,
						init_state=RigidObjectCfg.InitialStateCfg(
							pos=(-0.2893, -0.3219, 0.952),
							rot=(1.0, 0.0, 0.0, 0.0),
						),
					)
	...
	sodacan0 = RigidObjectCfg(
						...
						spawn=None,
						init_state=RigidObjectCfg.InitialStateCfg(
							pos=(1.2821, -2.2579, 0.8305),
							rot=(-0.7071, 0.0, 0.0, 0.7071),
						),
					)
	sodacan1 = RigidObjectCfg(
						prim_path="{ENV_REGEX_NS}/Kitchen/sodacan1",
						spawn=None,
						init_state=RigidObjectCfg.InitialStateCfg(
							pos=(1.2616, -2.3423, 0.8305),
							rot=(-0.7071, 0.0, 0.0, 0.7071),
						),
					)
	sodacan2 = RigidObjectCfg(
						prim_path="{ENV_REGEX_NS}/Kitchen/sodacan2",
						spawn=None,
						init_state=RigidObjectCfg.InitialStateCfg(
							pos=(1.2644, -2.6451, 0.8305),
							rot=(-0.7071, 0.0, 0.0, 0.7071),
						),
					)
	sodacan3 = RigidObjectCfg(
						prim_path="{ENV_REGEX_NS}/Kitchen/sodacan3",
						spawn=None,
						init_state=RigidObjectCfg.InitialStateCfg(
							pos=(1.261, -2.3255, 1.0934),
							rot=(-0.7071, 0.0, 0.0, 0.7071),
						),
					)
