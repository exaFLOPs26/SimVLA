...
class CabinetSceneCfg(InteractiveSceneCfg):
	...
	floor_list = ["{NVIDIA_NUCLEUS_DIR}/Materials/Base/Metals/Aluminum_Anodized.mdl","{NVIDIA_NUCLEUS_DIR}/Materials/Base/Wood/Cherry_Planks.mdl" ]
	wall_list = []	
	# plane  
	floor = AssetBaseCfg(
			...
			spawn=sim_utils.UsdFileCfg(
				...
				scale=(6.0,6.0,1.0),
				visual_material=MdlFileCfg(mdl_path=random.choice(floor_list)),
			),
			collision_group=-1,
			)
#	plane = AssetBaseCfg(
...
#		collision_group=-1,
#	)
#sim_utils.bind_visual_material(prim_path='/World/GroundPlane',material_path="file:/root/IsaacLab/source/isaaclab_assets/data/Materials/Mortar_Antique_White.mdl")
	# lights
	light = AssetBaseCfg(
...
#	floor_material = EventTerm(
#		func=mdp.randomize_visual_texture_material,
#		mode="startup",
#		params={
#			"event_name":"floor_material",
#			"asset_cfg": SceneEntityCfg("cabinet_02"),
#			"texture_paths": ["{NVIDIA_NUCLEUS_DIR}/Materials/Base/Metals/Aluminum_Anodized.mdl"]
#		},
#	)
